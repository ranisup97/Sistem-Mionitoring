							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<!--action-->
									...
									<!--DELETE-->
											...
											<a onclick="statusConfirm('<?php echo site_url('admin/cycle/edit_status/1/'.$var->id) ?>')"
											 href="#!" class="btn btn-primary btn-sm <?php echo $var->cycle1_status == 0 ? '' : 'disabled' ?>">Ubah Status</a>
										<!--CheckBox-->
										</td>
									</tr>
									<?php 
