						...
						<div class="table-responsive">
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<!--action-->
									<!--EDIT-->
										<td width="150">
											<a href="<?php echo site_url('admin/cycle/edit_detail/6/'.$pelatihan->id_pelatihan.'/'.$var->id) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i></a>

									<!--DELETE-->
											<a onclick="statusConfirm('<?php echo site_url('admin/cycle/edit_status_c4c5c6/6/'.$var->id.'/') ?>')"
											 href="#!" class="btn btn-primary btn-sm <?php echo $var->cycle6_status == 0 ? '' : 'disabled' ?>">Ubah Status</a>
										<!--CheckBox-->
										</td>
									</tr>
									<?php 
